...
export const getUnits = cache(async () => {
    ...
    // TODO: подумать, нужно ли добавить order
    ...
    // TODO: решение в лоб, можно упростить вычисления
...
export const getUserSubscription = cache(async () => {
    ...
    const data = await db.query.userSubscription.findFirst({ where: eq(userSubscription.userId, userId) });
